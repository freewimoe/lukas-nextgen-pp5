# Python Environment Manager für Windows PowerShell
# Speichere diese Datei als: python_manager_clean.ps1
...
function Update-ProjectDependencies {
    ...
    # Backup erstellen
    $BackupFile = "requirements_backup_$(Get-Date -Format 'yyyyMMdd_HHmmss').txt"
    pip freeze > $BackupFile
